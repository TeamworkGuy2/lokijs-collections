...
class PrimaryKeyMaintainer {
    ...
    private metaDataColl: DataCollection<CollectionMetaData, CollectionMetaData.OptionalModel> | null = null;
    private manageKeysCallCount: number;
    private reloadAll: boolean;
    private dataSrc: MemDb;
    ...
    private metaDataCollectionModel: DtoModel = {
        properties: {
            collectionName: {
                ...
                toLocal: <string><any>null,
                toService: <string><any>null
            },
            autoGeneratedKeys: {
     ...
     */
    constructor(metaDataCollectionName: string, reloadAll: boolean, dataSrc: MemDb, modelDefs: ModelDefinitions, modelKeys: ModelKeys) {
    ...
    private static loadCollectionMetaData(dbInst: MemDb, collectionName: string, dataModel: DataCollectionModel<any>): CollectionMetaData {
     ...
     */
    private static updateCollectionMetaData(dbInst: MemDb, collectionName: string, storedData: CollectionMetaData, modelData: DataCollectionModel<any>, reloadAll: boolean): CollectionMetaData {
        ...
        for (var i = 0, size = modelKeys.length; i < size; i++) {
            ...
            if (!reloadAll) {
                var found: { name: string; largestKey: number; } | null = null;
