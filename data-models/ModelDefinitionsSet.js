...
var ModelDefinitionsSet = /** @class */ (function () {
     ...
     */
    ModelDefinitionsSet.prototype.getPrimaryKeys = function (modelName) {
     ...
     */
    ModelDefinitionsSet.prototype.getAutoGeneratedKeys = function (modelName) {
        var modelDef = this.modelDefs[modelName];
        return modelDef && modelDef.autoGeneratedKeys || ModelDefinitionsSet.EMPTY_ARRAY;
    };
    ModelDefinitionsSet.prototype.getFields = function (modelName) {
        var modelDef = this.modelDefs[modelName];
        return modelDef && modelDef.fieldNames || ModelDefinitionsSet.EMPTY_ARRAY;
    };
    ModelDefinitionsSet.prototype.getModel = function (modelName) {
    ...
    ModelDefinitionsSet.fromCollectionModels = function (dataModels, cloneDeep) {
        if (cloneDeep === void 0) { cloneDeep = Objects.cloneDeep; }
...
(function (ModelDefinitionsSet) {
    ...
    function multiExtendModelTemplate() {
        ...
        for (var _i = 0; _i < arguments.length; _i++) {
            inheritanceChain[_i] = arguments[_i];
        }
