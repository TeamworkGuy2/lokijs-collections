...
class PrimaryKeyMaintainer {
    ...
    public manageKeys<T>(collectionName: string, docs: T[], addGeneratedKeys: boolean): void {
        ...
        this.metaDataColl = PrimaryKeyMaintainer.initMetaDataCollection(this.metaDataColl, this.metaDataCollectionName, this.modelKeys.getDataModel(this.metaDataCollectionName), this.dataSrc);
        var generatedIdNames = modelKeys.getDataModel(collectionName).autoGeneratedKeys;
    ...
    private static loadCollectionMetaData(dbInst: InMemDb, modelKeys: ModelKeys, collectionName: string): CollectionMetaData {
        ...
        var collMetaData = new CollectionMetaData(collectionName, dataModel.primaryKeys, dataModel.autoGeneratedKeys);
    ...
    private static initMetaDataCollection(dataColl: DataCollection<CollectionMetaData, CollectionMetaData.OptionalModel>, collectionName: string, dataModel: CollectionDataModel<any>, dbDataInst: InMemDb): DataCollection<CollectionMetaData, CollectionMetaData.OptionalModel> {
        if (dataColl == null) {
            return new DataCollectionImpl<CollectionMetaData, CollectionMetaData.OptionalModel>(collectionName, dataModel, dbDataInst);
        }
        return dataColl;
    }
