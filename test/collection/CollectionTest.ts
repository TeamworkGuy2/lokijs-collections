...
suite("collection", function () {
    ...
    test("findAndUpdate works", function () {
        var db = M.createDb("test.db");
        var coll = <MemDbCollection<{ a: number; b: number }>>db.addCollection("testcoll");
        coll.insert([{ a: 3, b: 3 }, { a: 6, b: 7 }, { a: 1, b: 2 }, { a: 7, b: 8 }, { a: 6, b: 4 }]);

        coll.findAndUpdate((obj) => obj.a === 6, (obj) => {
            obj.b += 1;
            return obj;
        });
    ...
    test("findAndRemove works", function () {
        ...
        var result = <any[]>(<any>coll.chain()).find().simplesort("b").data();
    ...
    test("removeBatch works", function () {
        ...
        results = <any[]>(<any>coll.chain()).find().simplesort("b").data();
    ...
    test("updateWhere works", function () {
        ...
        coll.findAndUpdate((fobj) => fobj.a === 6, (obj) => {
            obj.b += 1;
            return obj;
        });
    ...
    test("single inserts emit with meta when async listeners false", function () {
        ...
        coll.events.on("insert", function (obj) {
            ...
            switch (obj.a) {
                case 3: asr.equal(obj.b, 3); break;
                case 6: asr.equal(obj.b, 7); break;
                case 1: asr.equal(obj.b, 2); break;
                case 7: asr.equal(obj.b, 8); break;
                case 5: asr.equal(obj.b, 4); break;
            }
    ...
    test("batch inserts emit with meta", function () {
        ...
        coll.events.on("insert", function (obj) {
            ...
            asr.isTrue(obj.meta.created > 0);
            switch (cnt) {
                case 0: asr.equal(obj.b, 3); break;
                case 1: asr.equal(obj.b, 7); break;
                case 2: asr.equal(obj.b, 2); break;
                case 3: asr.equal(obj.b, 8); break;
                case 4: asr.equal(obj.b, 4); break;
            }
            cnt++;
        });
