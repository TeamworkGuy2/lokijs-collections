...
class PrimaryKeyMaintainer {
    ...
    private metaDataCollectionModel: DtoCollectionModel<CollectionMetaData> = {
        properties: {
            collectionName: { type: { typeName: "string" } },
            autoGeneratedKeys: { type: { typeName: "{ name: string; largestKey: number; }", arrayDimensions: 1 } },
            primaryKeys: { type: { typeName: "{ name: string }", arrayDimensions: 1 } },
        },
    ...
    private static initMetaDataCollection(dataColl: DataCollection<CollectionMetaData, CollectionMetaData.OptionalModel>,
            collectionName: string, dataModel: DtoModel | DtoCollectionModel<any> | DtoCollectionSvcModel<any, any>, dbDataInst: InMemDb): DataCollection<CollectionMetaData, CollectionMetaData.OptionalModel> {
        if (dataColl == null) {
