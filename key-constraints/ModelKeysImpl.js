...
var ModelKeysImpl = (function () {
    ...
    ModelKeysImpl.prototype.getUniqueIdNames = function (collectionName) {
        var modelName = this.modelDefs.getModelName(collectionName);
        return this.modelDefs.getUniqueIdNames(modelName);
    };
    // Get names of auto-generated id fields per collection
    ModelKeysImpl.prototype.getGeneratedIdNames = function (collectionName) {
        var modelName = this.modelDefs.getModelName(collectionName);
        return this.modelDefs.getAutoGeneratedKeyNames(modelName);
    };
    ...
    ModelKeysImpl.prototype.validateQuery = function (collectionName, query, obj) {
        ...
        if (!query) {
            query = {};
            var idNames = this.getUniqueIdNames(collectionName.toLowerCase());
            if (idNames.length <= 0) {
